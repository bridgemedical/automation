...
public class CapribedsideAdministerDerivativesPage {
	...
	public WebElement getIuConcentrationTextBox() {
		return iuConcentrationTextBox;
	}

	@FindBy(id = "grdAttributes__ctl8_listAttribute")
	public WebElement injectionSiteDropDown;

	public WebElement getInjectionSiteDropDown() {
		return injectionSiteDropDown;
	}
	...
	@FindBy(id = "grdAttributes__ctl11_dateAttribute_foo")
	public WebElement expiresTextBox;
